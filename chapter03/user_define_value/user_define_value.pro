#user_define_value.pro
TEMPLATE = app

CONFIG(debug,debug|release){
    TARGET = user_define_value_debug
}else{
    TARGET = user_define_value
}
...
SOURCES += $$PWD/MyValue.cpp
HEADERS += $$PWD/MyValue.hpp

SOURCES += $$PWD/MyValueCreator.cpp
HEADERS += $$PWD/MyValueCreator.hpp
...
QMLSOURCES += $$PWD/myqml/user_define_value/main.qml
