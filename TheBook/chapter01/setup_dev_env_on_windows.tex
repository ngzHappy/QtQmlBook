...
\begin{figure}[ht] %浮动体 here and top ...
\centering %中心对齐
\includegraphics[width=\textwidth]{chapter01/images/windows_qt_online_install.png} %图片路径
...
在Linux平台或类似平台下，
可以使用“LD\_PRELOAD”或类似的技术轻松的覆盖动态链接库中的函数。
...
并将编译结果放置到：
\begin{littlelongworld}
QtQmlBook\textbackslash{}sstd\_library\textbackslash{}memory\textbackslash{}libs
\end{littlelongworld}
文件夹下。
并将文件重命名为“jemalloc\_win64\_mingw\_730.a”。
如果读者实在无法静态编译jemalloc，
读者可以找到：
\begin{littlelongworld}
QtQmlBook\textbackslash{}sstd\_library\textbackslash{}\_sstd\_library\_memory.pri
\end{littlelongworld}
并将此文件内容清空。
