...
\marginnote{\setlength\fboxsep{2pt}\fbox{\footnotesize{\kaishu\figurename\,}\footnotesize{\ref{p000000a}}}}\centering %中心对齐
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0.97,0.98,0.99}{\includegraphics[width=8cm]{the_book_image/p000000a.pdf}} %图片路径
\caption{Qt官网下载内容} %标题
\label{p000000a} %索引
\end{figure}
%end图片
...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0.97,0.98,0.99}{\includegraphics[width=0.95\textwidth]{the_book_image/p000001.pdf}} %图片路径
