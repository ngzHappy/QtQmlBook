...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0,0,0}{\includegraphics[width=0.95\textwidth]{the_book_image/p000008.pdf}} %图片路径
...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0,0,0}{\includegraphics[width=0.95\textwidth]{the_book_image/p000009.pdf}} %图片路径
