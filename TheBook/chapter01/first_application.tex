...
Qt Quick依赖于OpenGL。\filesourcenumbernameone\ \ref{f000027}展
示常用OpenGL参数设置：
...
可以在QQuickView构造之前调用\begin{littlelongworld}
::qputenv("QSG\underline{\hspace{0.5em}}RENDER\underline{\hspace{0.5em}}LOOP","basic");
\end{littlelongworld}强制
QQuickView使用同步渲染。
