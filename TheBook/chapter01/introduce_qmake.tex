...
\item “SOURCES”代表需要编译的C/C{\sourcefontone{}+}{\sourcefontone{}+}源代码变量；
\item “HEADERS”代表C/C{\sourcefontone{}+}{\sourcefontone{}+}头文件变量；
\item “DEFINES”代表C/C{\sourcefontone{}+}{\sourcefontone{}+}宏变量；
...
\item 第28行将另一个文件引入此文件，它和C/C{\sourcefontone{}+}{\sourcefontone{}+}的“{\sourcefontone\#}include”工作原理一致；
\end{itemize}
...
它也引入了一些新的知识。
\begin{itemize}
\item 第2行使用“INCLUDEPATH”变量将当前目录加入C/C{\sourcefontone{}+}{\sourcefontone{}+}包含路径搜索路径；
\item 第3{\sourcefontone\~{}}7使用“LIBS”变量导入C/C{\sourcefontone{}+}{\sourcefontone{}+}链接库，
...
\caption{qmake对C/C{\sourcefontone{}+}{\sourcefontone{}+}编译链接过程控制点} %标题
\label{p000002} %索引
\end{figure}


如\figurename\ \ref{p000002}
一个C/C{\sourcefontone{}+}{\sourcefontone{}+}程序编译至少可以抽象出三个节点，
源代码编译前，
链接前以及链接后。
这三个时刻分别对应于qmake变量：
