...
DEFINES += QT_DEPRECATED_WARNINGS(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
}(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
└── the_app
    ├── main.cpp
    └── the_app.pro(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\treeindexnumbernameone\,}\footnotesize{\thetreeindexnumber}}]{\fbox{\scriptsize{\kaishu\treeindexnumbernameone\,}\footnotesize{\thetreeindexnumber}}}@*)\end{lstlisting}          %抄录环境
...
SUBDIRS += the_app(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
SOURCES += $$PWD/main.cpp
include($$PWD/../test_library/import_test_library.pri)(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
DESTDIR =  $$PWD/../bin
DEFINES *= D_TEST_LIBRARY(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
%test_library.pro
...
\marginnote{\fbox{\scriptsize{\kaishu\figurename\,}\footnotesize{\ref{p000002}}}}\centering %中心对齐
...
└── the_run
    ...
    ├── test1.hpp
    ├── test2.hpp
    └── the_run.pro(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\treeindexnumbernameone\,}\footnotesize{\thetreeindexnumber}}]{\fbox{\scriptsize{\kaishu\treeindexnumbernameone\,}\footnotesize{\thetreeindexnumber}}}@*)\end{lstlisting}          %抄录环境
\addtocounter{lstlisting}{-1}   %sub lstlisting counter ...
%\end{spacing}
 %tree.txt
...
SUBDIRS += the_run(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %advance_use_qmake.pro
...
export(QMAKE_POST_LINK)(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %the_run.pro
...
qmake -r -tp vc < 工程名称 >(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\commandnumbernameone\,}\footnotesize{\thecommandnumber}}]{\fbox{\scriptsize{\kaishu\commandnumbernameone\,}\footnotesize{\thecommandnumber}}}@*)\end{lstlisting}          %抄录环境
\addtocounter{lstlisting}{-1}   %sub lstlisting counter ...
%\end{spacing}
...
echo Remember to call vcvarsall.bat to complete environment setup!(*@\marginpar[\hfill\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}]{\fbox{\scriptsize{\kaishu\lstlistingname\,}\footnotesize{\thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
\begin{figure}[htb] %浮动体 here and top ...
%there must use marginnote not use marginpar ...
\marginnote{\fbox{\scriptsize{\kaishu\figurename\,}\footnotesize{\ref{p000003}}}}\centering %中心对齐
...
\begin{figure}[htb] %浮动体 here and top ...
%there must use marginnote not use marginpar ...
\marginnote{\fbox{\scriptsize{\kaishu\figurename\,}\footnotesize{\ref{p000004}}}}\centering %中心对齐
...
\begin{figure}[htb] %浮动体 here and top ...
%there must use marginnote not use marginpar ...
\marginnote{\fbox{\scriptsize{\kaishu\figurename\,}\footnotesize{\ref{p000005}}}}\centering %中心对齐
