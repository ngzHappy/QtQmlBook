...
本节代码树如
\treeindexnumbernameone\ \ref{d000000}
所示。
...
本节示例向读者展示：
\begin{itemize}
\item 在编译开始前，调动“new\underline{\hspace{0.5em}}moc”自动生成cpp文件并加入编译过程；
\item 在连接前调用“before\underline{\hspace{0.5em}}run”，“before\underline{\hspace{0.5em}}run”程序
向“the\underline{\hspace{0.5em}}run”文件夹下建立一个“before\underline{\hspace{0.5em}}run.txt”；
\item 在连接完成后调用“after\underline{\hspace{0.5em}}run”，“after\underline{\hspace{0.5em}}run”程序向
向“the\underline{\hspace{0.5em}}run”文件夹下建立一个“after\underline{\hspace{0.5em}}run.txt”；
\end{itemize}
