...
DEFINES += QT_DEPRECATED_WARNINGS(*@\marginpar[\hfill\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}]{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
└── the_app
    ├── main.cpp
    └── the_app.pro(*@\marginpar[\hfill\fbox{\footnotesize{\treeindexnumbernameone\ \thetreeindexnumber}}]{\fbox{\footnotesize{\treeindexnumbernameone\ \thetreeindexnumber}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
SUBDIRS += the_app(*@\marginpar[\hfill\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}]{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
SOURCES += $$PWD/main.cpp
include($$PWD/../test_library/import_test_library.pri)(*@\marginpar[\hfill\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}]{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
DESTDIR =  $$PWD/../bin
DEFINES *= D_TEST_LIBRARY(*@\marginpar[\hfill\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}]{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
%test_library.pro
...
\marginnote{\fbox{\footnotesize{\figurename\ \ref{p000002}}}}\centering %中心对齐
\includegraphics[width=0.95\textwidth]{chapter01/images/advance_use_qmake.png} %图片路径
\caption{qmake对C/C{\sourcefonttwo{}+}{\sourcefonttwo{}+}编译链接过程控制点} %标题
\label{p000002} %索引
\end{figure}
%end图片
...
└── the_run
    ...
    ├── test1.hpp
    ├── test2.hpp
    └── the_run.pro(*@\marginpar[\hfill\fbox{\footnotesize{\treeindexnumbernameone\ \thetreeindexnumber}}]{\fbox{\footnotesize{\treeindexnumbernameone\ \thetreeindexnumber}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %tree.txt
...
SUBDIRS += the_run(*@\marginpar[\hfill\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}]{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %advance_use_qmake.pro
...
export(QMAKE_POST_LINK)(*@\marginpar[\hfill\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}]{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %the_run.pro
...
qmake -r -tp vc < 工程名称 >(*@\marginpar[\hfill\fbox{\footnotesize{\commandnumbernameone\ \thecommandnumber}}]{\fbox{\footnotesize{\commandnumbernameone\ \thecommandnumber}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
echo Remember to call vcvarsall.bat to complete environment setup!(*@\marginpar[\hfill\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}]{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
\begin{figure}[htb] %浮动体 here and top ...
%there must use marginnote not use marginpar ...
\marginnote{\fbox{\footnotesize{\figurename\ \ref{p000003}}}}\centering %中心对齐
...
\begin{figure}[htb] %浮动体 here and top ...
%there must use marginnote not use marginpar ...
\marginnote{\fbox{\footnotesize{\figurename\ \ref{p000004}}}}\centering %中心对齐
...
\begin{figure}[htb] %浮动体 here and top ...
%there must use marginnote not use marginpar ...
\marginnote{\fbox{\footnotesize{\figurename\ \ref{p000005}}}}\centering %中心对齐
