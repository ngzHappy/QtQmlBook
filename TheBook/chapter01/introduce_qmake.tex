...
DEFINES += QT_DEPRECATED_WARNINGS(*@\marginpar{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
└── the_app
    ├── main.cpp
    └── the_app.pro(*@\marginpar{\fbox{\footnotesize{\treeindexnumbernameone\ \thetreeindexnumber}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
SUBDIRS += the_app(*@\marginpar{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
SOURCES += $$PWD/main.cpp
include($$PWD/../test_library/import_test_library.pri)(*@\marginpar{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
DESTDIR =  $$PWD/../bin
DEFINES *= D_TEST_LIBRARY(*@\marginpar{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
%test_library.pro
...
└── the_run
    ...
    ├── test1.hpp
    ├── test2.hpp
    └── the_run.pro(*@\marginpar{\fbox{\footnotesize{\treeindexnumbernameone\ \thetreeindexnumber}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %tree.txt
...
SUBDIRS += the_run(*@\marginpar{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %advance_use_qmake.pro
...
export(QMAKE_POST_LINK)(*@\marginpar{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
 %the_run.pro
...
%\begin{spacing}{1.0}
\FloatBarrier
\refstepcounter{commandnumber}\label{command000003}    %增加目录树编号
\begin{lstlisting}[escapeinside={(*@}{@*)},
caption=GoodLuck,
title=\commandnumbernameone\ \thecommandnumber
]
qmake -r -tp vc < 工程名称 >(*@\marginpar{\fbox{\footnotesize{\commandnumbernameone\ \thecommandnumber}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
...
echo Remember to call vcvarsall.bat to complete environment setup!(*@\marginpar{\fbox{\footnotesize{\lstlistingname\ \thelstlisting}}}@*)\end{lstlisting}          %抄录环境
%\end{spacing}
