...
\begin{itemize}
\item 第1\raisebox{0.2ex}{\sourcefonttwo\~{}}2行表示不使用Qt库；
\item 第4行表示这是一个控制台应用程序；
\item 第6\raisebox{0.2ex}{\sourcefonttwo\~{}}10行表示在debug模式下输出目标名称是“hellow\underline{\hspace{0.5em}}world\underline{\hspace{0.5em}}debug”，
在release模式下输出目标名称是“hellow\underline{\hspace{0.5em}}world”；
\item 第12行表示输出的是一个应用程序；
\item 第14\raisebox{0.2ex}{\sourcefonttwo\~{}}18行表示使用C{\sourcefonttwo{}+}{\sourcefonttwo{}+} 17标准；
...
\item “\raisebox{0.2ex}{\sourcefonttwo\~{}}{\sourcefonttwo{}=}”代表替换变量中的值；
...
第6\raisebox{0.2ex}{\sourcefonttwo\~{}}10行和14\raisebox{0.2ex}{\sourcefonttwo\~{}}18虽然写法不同，实际上都是检查“CONFIG”中是否定义了特定项。
...
比起上一节，它多了一些新的知识点。
\begin{itemize}
\item 第21\raisebox{0.2ex}{\sourcefonttwo\~{}}23行更改了在非Windows平台下程序的链接参数，
...
\item 第3\raisebox{0.2ex}{\sourcefonttwo\~{}}7行使用“LIBS”变量导入C/C{\sourcefonttwo{}+}{\sourcefonttwo{}+}链接库，
...
\begin{itemize}
\item 第28\raisebox{0.2ex}{\sourcefonttwo\~{}}41行展示了如何使用
“QMAKE\underline{\hspace{0.5em}}EXTRA\underline{\hspace{0.5em}}COMPILERS”。
...
读者可以用此技术实现自定义代码生成器，
不过这需要读者有编译原理相关知识。
\item 第44\raisebox{0.2ex}{\sourcefonttwo\~{}}49行展示了如何使用
...
\item 第52\raisebox{0.2ex}{\sourcefonttwo\~{}}57行展示了如何使用
“QMAKE\underline{\hspace{0.5em}}POST\underline{\hspace{0.5em}}LINK”。
