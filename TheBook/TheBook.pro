...
DISTFILES += $$PWD/chapter01/introduce_qmake.txt
DISTFILES += $$PWD/chapter01/first_application.txt
...
DISTFILES += $$PWD/chapter01/introduce_qmake.tex
DISTFILES += $$PWD/chapter01/first_application.tex
