...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0,0,0}{\includegraphics[width=0.95\textwidth]{the_book_image/p000044.pdf}} %图片路径
...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0,0,0}{\includegraphics[width=0.95\textwidth]{the_book_image/p000045.pdf}} %图片路径
\caption{使用QtCreator创建模型} %标题
\label{p000045} %索引
\end{figure}
%end图片
...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0,0,0}{\includegraphics[width=0.95\textwidth]{the_book_image/p000046.pdf}} %图片路径
\caption{使用QtCreator创建模型} %标题
\label{p000046} %索引
\end{figure}
%end图片
...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0,0,0}{\includegraphics[height=0.75\textwidth]{the_book_image/p000047.pdf}} %图片路径
\caption{List} %标题
\label{p000047} %索引
\end{figure}
%end图片
