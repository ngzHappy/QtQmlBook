...
\setlength\fboxsep{0pt}\fbox{\includegraphics[width=0.95\textwidth]{the_book_image/p000044.eps}} %图片路径
...
\setlength\fboxsep{0pt}\fbox{\includegraphics[width=0.95\textwidth]{the_book_image/p000045.eps}} %图片路径
\caption{使用QtCreator创建模型} %标题
\label{p000045} %索引
\end{figure}
%end图片
...
如果没有选择任何功能，则创建一个只读的模型。
    ...
    \begin{itemize}
\item Customize header row

自定义标题
\item Items are editable

数据元素可编辑
\item Rows and columns can be added

可以添加行或列
\item Rows and columns can be removed

可以删除行或列
\item Fetch data dynamically
...
\setlength\fboxsep{0pt}\fbox{\includegraphics[width=0.95\textwidth]{the_book_image/p000046.eps}} %图片路径
\caption{使用QtCreator创建模型} %标题
\label{p000046} %索引
\end{figure}
%end图片
