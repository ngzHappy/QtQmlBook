...
language=C,
breaklines=true,
basicstyle=     \footnotesize\slshape\sourcefontone , %设置字号，字体
stringstyle=    \footnotesize\slshape\sourcefontone , %设置字号，字体
keywordstyle=   \footnotesize\slshape\sourcefontone , %设置字号，字体
commentstyle=   \footnotesize\slshape\sourcefontone , %设置字号，字体
identifierstyle=\footnotesize\slshape\sourcefontone , %设置字号，字体
numbers=left,
numberstyle=    \scriptsize\sourcefontthree      , %设置字号，字体
frame=single,
