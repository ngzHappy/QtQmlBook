...
\usepackage{fontspec}
\definecolor{sourcegrayone}{rgb}{0.9,0.9,0.85}  %源代码背景颜色
...
language=C,
breaklines=true,
basicstyle=\small\sourcefontone ,
stringstyle=\small\sourcefontone ,
keywordstyle=\small\sourcefontone ,
commentstyle=\small\sourcefontone ,
identifierstyle=\small\sourcefontone ,
numbers=left,
numberstyle=\footnotesize , %设置字号
frame=single,
...
\renewcommand\theTreeIndexNumber{目录树\ \thechapter.\arabic{treeIndexNumber}}
