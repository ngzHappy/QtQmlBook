...
\setlength\fboxsep{0pt}\fcolorbox[rgb]{0,0,0}{0.97,0.98,0.99}{\includegraphics[width=0.95\textwidth]{the_book_image/p000042.pdf}} %图片路径
...
%\begin{spacing}{1.0}
\refstepcounter{filesourcenumber}\label{f000076}    %增加源代码编号
