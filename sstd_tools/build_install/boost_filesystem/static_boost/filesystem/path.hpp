...
#include <static_boost/filesystem/path_traits.hpp>  // includes <cwchar>
#include <static_boost/system/error_code.hpp>
#include <static_boost/system/system_error.hpp>
#include <static_boost/iterator/iterator_facade.hpp>
#include <static_boost/shared_ptr.hpp>
#include <static_boost/io/detail/quoted_manip.hpp>
#include <static_boost/static_assert.hpp>
#include <static_boost/functional/hash_fwd.hpp>
#include <static_boost/type_traits/is_integral.hpp>
#include <string>
#include <iterator>
#include <cstring>
#include <iosfwd>
