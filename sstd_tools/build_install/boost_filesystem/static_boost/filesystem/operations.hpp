...
#include <static_boost/filesystem/config.hpp>
#include <static_boost/filesystem/path.hpp>

#include <static_boost/detail/scoped_enum_emulation.hpp>
#include <static_boost/detail/bitmask.hpp>
#include <static_boost/system/error_code.hpp>
#include <static_boost/system/system_error.hpp>
#include <static_boost/shared_ptr.hpp>
#include <static_boost/utility/enable_if.hpp>
#include <static_boost/type_traits/is_same.hpp>
#include <static_boost/cstdint.hpp>
#include <static_boost/range/mutable_iterator.hpp>
#include <static_boost/range/const_iterator.hpp>
...
#include <static_boost/config/abi_prefix.hpp> // must be the last #include
...
#include <static_boost/config/abi_suffix.hpp> // pops abi_prefix.hpp pragmas
