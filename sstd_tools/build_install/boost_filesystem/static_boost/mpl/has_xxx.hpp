...
#include <static_boost/mpl/aux_/config/gcc.hpp>
#include <static_boost/mpl/aux_/config/has_xxx.hpp>
#include <static_boost/mpl/aux_/config/msvc_typename.hpp>
...
#include <static_boost/preprocessor/array/elem.hpp>
#include <static_boost/preprocessor/cat.hpp>
#include <static_boost/preprocessor/control/if.hpp>
#include <static_boost/preprocessor/repetition/enum_params.hpp>
#include <static_boost/preprocessor/repetition/enum_trailing_params.hpp>

#if BOOST_WORKAROUND( __BORLANDC__, BOOST_TESTED_AT(0x590) )
# include <static_boost/type_traits/is_class.hpp>
#endif
