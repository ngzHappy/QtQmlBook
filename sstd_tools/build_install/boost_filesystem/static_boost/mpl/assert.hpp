...
#include <static_boost/mpl/aux_/nested_type_wknd.hpp>
#include <static_boost/mpl/aux_/yes_no.hpp>
#include <static_boost/mpl/aux_/na.hpp>
#include <static_boost/mpl/aux_/adl_barrier.hpp>

#include <static_boost/mpl/aux_/config/nttp.hpp>
...
#include <static_boost/mpl/aux_/config/gpu.hpp>
#include <static_boost/mpl/aux_/config/static_constant.hpp>
#include <static_boost/mpl/aux_/config/pp_counter.hpp>
#include <static_boost/mpl/aux_/config/workaround.hpp>

#include <static_boost/preprocessor/cat.hpp>

#include <static_boost/config.hpp> // make sure 'size_t' is placed into 'std'
#include <cstddef>
