...
#include <static_boost/config.hpp>   // for broken compiler workarounds

// In order to avoid circular dependencies with Boost.TR1
// we make sure that our include of <memory> doesn't try to
// pull in the TR1 headers: that's why we use this header 
// rather than including <memory> directly:
#include <static_boost/config/no_tr1/memory.hpp>  // std::auto_ptr

#include <static_boost/assert.hpp>
#include <static_boost/checked_delete.hpp>
#include <static_boost/throw_exception.hpp>
#include <static_boost/smart_ptr/detail/shared_count.hpp>
#include <static_boost/detail/workaround.hpp>
#include <static_boost/smart_ptr/detail/sp_convertible.hpp>
#include <static_boost/smart_ptr/detail/sp_nullptr_t.hpp>
#include <static_boost/smart_ptr/detail/sp_disable_deprecated.hpp>
#include <static_boost/smart_ptr/detail/sp_noexcept.hpp>

#if !defined(BOOST_SP_NO_ATOMIC_ACCESS)
#include <static_boost/smart_ptr/detail/spinlock_pool.hpp>
#endif
...
#include <static_boost/smart_ptr/detail/operator_bool.hpp>
...
#include <static_boost/smart_ptr/detail/local_sp_deleter.hpp>
