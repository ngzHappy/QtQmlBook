...
# include <static_boost/preprocessor/control/iif.hpp>
# include <static_boost/preprocessor/facilities/is_1.hpp>
# include <static_boost/preprocessor/tuple/size.hpp>
