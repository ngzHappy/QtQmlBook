...
CONFIG(debug,debug|release){
    TARGET = directdrawbyopengl_debug
}else{
    TARGET = directdrawbyopengl
}
...
SOURCES += $$PWD/DrawImageItem.cpp

HEADERS += $$PWD/DrawImageItem.hpp
...
QMLSOURCES += $$PWD/myqml/directdrawbyopengl/main.qml
