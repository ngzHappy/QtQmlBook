#applicationwindow_control2.pro
TEMPLATE = app

CONFIG(debug,debug|release){
    TARGET = applicationwindow_control2_debug
}else{
    TARGET = applicationwindow_control2
}
...
QMLSOURCES += $$PWD/myqml/applicationwindow_control2/main.qml
