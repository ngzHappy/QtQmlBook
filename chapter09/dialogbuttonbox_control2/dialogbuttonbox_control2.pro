#dialogbuttonbox_control2.pro
TEMPLATE = app

CONFIG(debug,debug|release){
    TARGET = dialogbuttonbox_control2_debug
}else{
    TARGET = dialogbuttonbox_control2
}
...
QMLSOURCES += $$PWD/myqml/dialogbuttonbox_control2/main.qml
