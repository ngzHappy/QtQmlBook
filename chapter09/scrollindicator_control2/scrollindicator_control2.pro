#scrollindicator_control2.pro
TEMPLATE = app

CONFIG(debug,debug|release){
    TARGET = scrollindicator_control2_debug
}else{
    TARGET = scrollindicator_control2
}
...
QMLSOURCES += $$PWD/myqml/scrollindicator_control2/main.qml
