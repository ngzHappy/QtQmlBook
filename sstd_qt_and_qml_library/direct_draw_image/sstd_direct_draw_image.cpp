#include "sstd_direct_draw_image.hpp"
#include <string_view>
#include <array>
...
_0_sstd_direct_draw_image::_0_sstd_direct_draw_image() {
    this->setFlag(QQuickItem::ItemHasContents, true);
}

QSGNode * _0_sstd_direct_draw_image::updatePaintNode(
    QSGNode *oldNode,
...
QImage _0_sstd_direct_draw_image::getImage() const {
    return mmmImage;
}

void _0_sstd_direct_draw_image::pppSetImage(const QVariant & arg) {
    QImage varTmp;
...
static inline void register_this() {
    qmlRegisterType<_0_sstd_direct_draw_image>(
        "sstd.quick",
        1, 0,
        "DirectDrawImage");
}
