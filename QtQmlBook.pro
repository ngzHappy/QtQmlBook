...
app_first_cplusplus_extern.depends = sstd_qml_control
...
app_statemachine.depends = sstd_qml_control
...
app_emitters_particlesystem.depends = sstd_qml_control
...
app_affectors_particlesystem.depends = sstd_qml_control
...
app_conicalgradient_effect.depends = sstd_qml_control
...
app_lineargradient_effect.depends = sstd_qml_control
...
app_control_1_user_define_style.depends = sstd_qml_control
...
app_control_2_user_define_style.depends = sstd_qml_control
...
app_applicationwindow_control2.depends = sstd_qt_and_qml_library
...
app_radiobutton_control2.depends = sstd_qt_and_qml_library
...
app_radiodelegate_control2.depends = sstd_qt_and_qml_library
...
app_rangeslider_control2.depends = sstd_qt_and_qml_library
...
app_scrollindicator_control2.depends = sstd_qt_and_qml_library
