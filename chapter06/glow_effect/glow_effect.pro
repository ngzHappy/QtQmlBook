...
QMLSOURCES += $$PWD/myqml/glow_effect/main.qml
QMLSOURCES += $$PWD/myqml/glow_effect/SliderControl.qml
QMLSOURCES += $$PWD/myqml/glow_effect/GlowControl.qml
