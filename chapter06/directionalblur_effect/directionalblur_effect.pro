#directionalblur_effect.pro
TEMPLATE = app

CONFIG(debug,debug|release){
    TARGET = directionalblur_effect_debug
}else{
    TARGET = directionalblur_effect
}
...
QMLSOURCES += $$PWD/myqml/directionalblur_effect/main.qml
QMLSOURCES += $$PWD/myqml/directionalblur_effect/SliderControl.qml
QMLSOURCES += $$PWD/myqml/directionalblur_effect/DirectionalblurControl.qml
